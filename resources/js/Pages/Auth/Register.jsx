...
export default function Register() {
    ...
    useEffect(() => {
        data.name.length > 3 && data.name.length < 10
        ...
        <GuestLayout>
            ...
            <form onSubmit={submit} className=" mt-[26vh] pt-5 sm:pt-6">
                <div>
                    ...
                    />
                    <p
                        className={`text-gray-300 text-[14px] mt-2 ${
                            userTextVisible ? "block" : "hidden"
                        }`}
                    >
                        Enter anonymous Username eg: user@5$#
                    </p>
                ...
                >
                    ...
                    <div className=" text-sky-500 my-2 capitalize">
                ...
                <div className="flex flex-col-reverse mt-4 items-center justify-center gap-y-4">
                    ...
                    <PrimaryButton
                        className="mt-3 transition-all duration-300 ease-in-out disabled:bg-slate-100 disabled:text-gray-900 bg-sky-500 hover:bg-sky-300"
                        disabled={processing || disabledBtn}
                    >
                        {processing && (
