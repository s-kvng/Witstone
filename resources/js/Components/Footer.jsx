            ...
            <div className="flex justify-center align-items-center md:gap-24 gap-14 py-2">
                <div className="flex flex-col gap-y-1 align-items-center text-center">
                    <Link href={route("posts.index")}>
                        <div className=" bg-zinc-100 dark:bg-gray-950 rounded-full p-4 dark:shadow-sm dark:shadow-gray-400 shadow-lg ">
                            <FaHome size={30} className="text-sky-700" />
                        </div>
                    </Link>
                ...
                <div className="flex flex-col gap-y-1 align-items-center  text-center">
                    <Link href={route("posts.create")}>
                        <div className=" bg-zinc-100 dark:bg-gray-950   rounded-full py-[20px] px-0 flex justify-center align-items-center dark:shadow-sm dark:shadow-gray-400 shadow-lg">
                            <FaPlus size={20} className=" text-sky-700 " />
                        </div>
                    </Link>
